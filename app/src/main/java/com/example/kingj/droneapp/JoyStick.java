...
{
    //To make the joystick automatically fit with the size of the canvas, we have to use global variables and calculate the joystick positions and sizes at runtime.
    ...
    {
        //We will also need a method, void setupDimensions(), to assign the variables their values
        centerX = getWidth() / 2;
        centerY = getHeight() / 2;
